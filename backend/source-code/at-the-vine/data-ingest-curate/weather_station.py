...
WF_SHARED_KEY = '?api_key=12345-1234567890-12345-12345678901234567890'
#LONESOME_VINE_API_KEY = 'private API key guarantees avail / throughput'

API_KEY = WF_SHARED_KEY
WF_STATION_ID = '12345'                        #unique per WF station
SHADOW_CLIENT = "WFStationShadow"              #arbitrary value

# REST API public endpoint used to update the WeatherStation's IoT shadow
HOST_NAME = '12345678901234-ats.iot.us-east-1.amazonaws.com' #unique per AWS acct

ROOT_CA = 'Security/Amazon_root_CA_1.pem'      #public, shared across stations
PRIVATE_KEY = 'Security/1234567890-private.pem.key'    #unique per WF station
CERT_FILE = 'Security/1234567890-certificate.pem.crt'  #unique per WF station
